...
Plane::Plane(float x, float y, float z, float width, float height, float repeatWidth, float repeatHeight, std::string const vertexShader, std::string const fragmentShader, std::string const texture):
